        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 sm:mb-8 text-white">
              Unlocking Unprecedented <span className="text-purple-400">User Behavior</span> & <span className="text-red-400">Ad Intelligence</span>
            </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black mb-6 sm:mb-8 text-white">
              Privacy by <span className="text-green-400">Design</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/5 rounded-2xl p-8 border border-green-500/20">
                ...
                <div className="space-y-4 text-gray-300">
                  ...
                  <p className="text-green-400 text-sm font-medium">✓ Zero server-side personal data storage</p>
                </div>
              </div>

              <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/5 rounded-2xl p-8 border border-blue-500/20">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                ...
                <div className="space-y-4 text-gray-300">
                  ...
                  <p className="text-blue-400 text-sm font-medium">✓ Mathematically proven privacy guarantees</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/5 rounded-2xl p-8 border border-purple-500/20">
                ...
                <div className="space-y-4 text-gray-300">
                  ...
                  <p className="text-purple-400 text-sm font-medium">✓ Hardware-level security guarantees</p>
                </div>
              </div>

              <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/5 rounded-2xl p-8 border border-yellow-500/20">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                  <Eye className="w-8 h-8 mr-3 text-yellow-400" />
                  Full Transparency
                </h3>
                <div className="space-y-4 text-gray-300">
                  ...
                  <p className="text-yellow-400 text-sm font-medium">✓ Verifiable privacy through code inspection</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-3xl p-8 border border-green-500/20">
              ...
              <WaitlistForm 
                ...
                triggerClassName="text-base sm:text-lg lg:text-xl px-8 sm:px-10 lg:px-12 py-4 sm:py-5 lg:py-6 bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white font-black shadow-2xl hover:shadow-green-500/50 transform hover:scale-105"
              />
            </div>
          </div>
        </div>
