              ...
              >
                <div className="relative cursor-pointer">
                  ...
                  <Badge className="relative bg-gradient-to-r from-red-500/40 to-pink-500/40 text-red-100 border-red-400/60 px-3 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 text-xs sm:text-sm lg:text-lg font-black shadow-2xl shadow-red-500/30 hover:scale-105 transition-transform duration-300 header-breathe cursor-pointer">
                    ...
                    <span className="hidden sm:inline">GET PAID TO WATCH YOUTUBE • JOIN THE REVOLUTION</span>
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            ...
            <div className="text-center mb-8 sm:mb-12">
              <div className="inline-flex items-center gap-4 bg-red-500/20 border border-red-500/30 rounded-full px-6 py-3 mb-6">
                ...
                <span className="text-white font-bold text-sm sm:text-base">LIVE: Join our community for early product access</span>
                <div className="w-3 h-3 bg-red-500 rounded-full animate-pulse"></div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              ...
              <Link href="/join-waitlist" className="group">
                <Card className="bg-gradient-to-br from-red-500/10 to-pink-500/5 backdrop-blur-xl border border-red-500/20 p-6 hover:border-red-400/50 transition-all duration-500 hover:scale-105 shadow-2xl h-full">
                  ...
                  <h3 className="text-xl font-bold text-white mb-3 group-hover:text-red-400 transition-colors">Join Community</h3>
                  <p className="text-gray-300 text-sm">Get early access & product updates</p>
                  </div>
                </Card>
              </Link>
            </div>
